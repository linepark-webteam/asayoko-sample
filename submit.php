...
if ($_POST) {
  if ($_POST) {
    ...
    // 送信元のメールアドレスを設定
    $fromEmail = "info@asayoko-shusei.online";

    // send email
    $headers = "From: $fromEmail\r\n";
    $headers .= "Reply-To: $email\r\n";
    $headers .= "X-Mailer: PHP/" . phpversion();
    mail("ywg.japan@gmail.com", "お問い合わせを受け付けました", $content, $headers);
    mail("ko.nagai.0801@gmail.com", "お問い合わせを受け付けました", $content, $headers);
